...
INSERT INTO `' . $this->table . '` (`' . implode('`, `', array_keys($data)) . '`) VALUES (' . implode(',',
                array_values($data)) . ')', $this->export());
...
UPDATE `' . $this->table . '` SET ' . implode(',',
                $data) . ' WHERE `' . $this->primaryField . '` = {{ i(' . $this->primaryField . ') }}',
            $this->export());
        return true;
    }
...
DELETE FROM `' . $this->table . '` WHERE `' . $this->primaryField . '` = {{ i(' . $this->primaryField . ') }}',
            [$this->primaryField => $this->data['id']]);
        return true;
    }
...
SELECT * FROM `' . $this->table . '` WHERE `' . $this->primaryField . '` = {{ i(' . $this->primaryField . ') }}',
